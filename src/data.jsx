...
const PRODUCTS = [
  { id: "p1", title: "Órbita", kind: "Vinilo 180g", price: "€28", tag: "EDICIÓN LIMITADA", art: "a", stock: "137 / 500" },
  { id: "p2", title: "Cielo raso", kind: "CD firmado", price: "€18", tag: "FIRMADO", art: "b", stock: "Disponible" },
  { id: "p3", title: "Hoodie Señal", kind: "Merch — Algodón orgánico", price: "€52", tag: "NUEVO", art: "c", stock: "S · M · L · XL" },
  { id: "p4", title: "Aurora", kind: "Casete edición azul", price: "€14", tag: "REEDICIÓN", art: "d", stock: "Pocas unidades" },
  { id: "p5", title: "Devocional tomo I", kind: "Libro tapa dura", price: "€22", tag: "LIBRO", art: "e", stock: "Envío abril" },
  { id: "p6", title: "Gorra Órbita", kind: "Merch — Bordado", price: "€32", tag: "MERCH", art: "f", stock: "Talla única" }
];

const TOUR = [
  { date: "2026 · 05 · 09", day: "09", mo: "MAY", city: "Madrid", co: "España", venue: "La Riviera", status: "live", statusLabel: "ENTRADAS" },
  { date: "2026 · 05 · 16", day: "16", mo: "MAY", city: "Barcelona", co: "España", venue: "Sala Razzmatazz", status: "sold", statusLabel: "AGOTADO" },
  { date: "2026 · 05 · 30", day: "30", mo: "MAY", city: "Ciudad de México", co: "México", venue: "Auditorio BB", status: "live", statusLabel: "ENTRADAS" },
  { date: "2026 · 06 · 07", day: "07", mo: "JUN", city: "Buenos Aires", co: "Argentina", venue: "Teatro Vorterix", status: "live", statusLabel: "ENTRADAS" },
  { date: "2026 · 06 · 14", day: "14", mo: "JUN", city: "Bogotá", co: "Colombia", venue: "Teatro Mayor", status: "soon", statusLabel: "PRONTO" },
  { date: "2026 · 06 · 21", day: "21", mo: "JUN", city: "Lima", co: "Perú", venue: "Arena Perú", status: "soon", statusLabel: "PRONTO" }
];
...
const loadDynamicData = () => {
  ...
  if (adminDevos.length > 0) {
    ...
    DEVOTIONAL = {
      date: new Date(latest.createdAt).toLocaleDateString('es-ES', {day: 'numeric', month: 'short', year: 'numeric'}).toUpperCase(),
      title: latest.title,
  ...
  Object.assign(window, { ALBUMS, PRODUCTS, TOUR, DEVOTIONAL, SCRIPTURE, SCRIPT_MARQUEE });
};
